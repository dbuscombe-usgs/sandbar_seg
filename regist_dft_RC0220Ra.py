...
def doproc(im0, file):
   ...
   outfile = '/run/media/dbuscombe/MASTER/GCMRC/SANDBAR_REMOTECAMERAS/RC0220Ra_regis/deployment7/'+file.split(os.sep)[-1].split('.jpg')[0]+'_reg.jpg'
