...
if __name__ == '__main__':
   ...
   master = '/run/media/dbuscombe/MASTER/GCMRC/SANDBAR_REMOTECAMERAS/RC0220Ra/deployment7/RC0220Ra_20130922_1353.jpg'

   direc = '/run/media/dbuscombe/MASTER/GCMRC/SANDBAR_REMOTECAMERAS/RC0220Ra/deployment7/'
   filenames = sorted(filter(os.listdir(direc), '*.[Jj][Pp][Gg]'))

   outdirec = '/run/media/dbuscombe/MASTER/GCMRC/SANDBAR_REMOTECAMERAS/RC0220Ra_regis/deployment7/'
   ...
   im2.save('temp/2d.pgm')
   im2 = np.asarray(im2)
   process_image('temp/2d.pgm', 'temp/2d.key')
   key2 = read_features_from_file('temp/2d.key')
