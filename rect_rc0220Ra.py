...
dat =  pickle.load( open( "RC0220Ra_surveydata/RC0220Ra_homo_mergedtrans.p", "rb" ) )

direc = '/run/media/dbuscombe/MASTER/GCMRC/SANDBAR_REMOTECAMERAS/RC0220Ra_regis/deployment7/'
