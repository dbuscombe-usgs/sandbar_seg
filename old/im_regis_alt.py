...
im1 = imread(master)[:,:,0]
im2 = imread("RC0220Ra_surveydata/RC0220Ra_20150924_1141.JPG")[:,:,0]
...
#    features1 = np.dstack(np.where(edges1.T > edges1.mean()))[0]
...
#        features = np.dstack(np.where(edges.T > edges.mean()))[0]
#        
